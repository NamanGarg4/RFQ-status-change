...
frappe.ui.form.on("Request for Quotation", {
    ...
    refresh: function(frm, cdt, cdn) {
        if (frm.doc.docstatus === 1) {
            ...
            // CORRECTED "Email It" BUTTON
            frm.add_custom_button(__('Email It'), function() {
                frappe.call({
                    method: "erpnext.buying.doctype.request_for_quotation.request_for_quotation.update_to_quotation_requested",
